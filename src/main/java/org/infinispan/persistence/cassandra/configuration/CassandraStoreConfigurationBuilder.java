...
public class CassandraStoreConfigurationBuilder extends AbstractStoreConfigurationBuilder<CassandraStoreConfiguration, CassandraStoreConfigurationBuilder>
    ...
    public CassandraStoreConfigurationBuilder localDatacenter(String localDatacenter) {
        attributes.attribute(CassandraStoreConfiguration.LOCAL_DATACENTER).set(localDatacenter);
        return this;
    }
    ...
    public CassandraStoreConfigurationBuilder addProperty(String key, String value) {
        switch (key) {
            ...
            case "localDatacenter":
                return localDatacenter(value);
            case "entryTable":
                return entryTable(value);
            case "readConsistencyLevel":
                return readConsistencyLevel(DefaultConsistencyLevel.valueOf(value));
            case "readSerialConsistencyLevel":
                return readSerialConsistencyLevel(DefaultConsistencyLevel.valueOf(value));
            case "writeConsistencyLevel":
                return writeConsistencyLevel(DefaultConsistencyLevel.valueOf(value));
            case "writeSerialConsistencyLevel":
                return writeSerialConsistencyLevel(DefaultConsistencyLevel.valueOf(value));
            ...
            case "connectionPool.heartbeatIntervalSeconds":
                ...
                return this;
            case "connectionPool.heartbeatTimeoutMs":
                connectionPool().heartbeatTimeoutMs(Integer.parseInt(value));
                return this;
            case "connectionPool.localSize":
                connectionPool().localSize(Integer.parseInt(value));
                return this;
            case "connectionPool.remoteSize":
                connectionPool().remoteSize(Integer.parseInt(value));
                return this;
            default:
    ...
    public CassandraStoreConfiguration create() {
        ...
        return new CassandraStoreConfiguration(attributes.protect(), async.create(), connectionPool.create());
    }
